...
class Agreement {
  ...
  async accept() {
    return await promisify(this.agreementContract.approve)({from: web3.eth.accounts[0]});
  }

  async reject() {
    return await promisify(this.agreementContract.reimburse)({from: web3.eth.accounts[0]});
  }
